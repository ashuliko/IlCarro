...
public class Car {
    ...
    String fuel;
    String gear;
    String wD; //D bol'shaya t.k.  wd - eyh web driver
    String doors;
    String seats;
    String clasS; // S bol'shaya t.k. slovo class v java zarezervirovano
    ...
    //Shift+Alt - odnovremenno izmenyat' vo vseh strokah
